<template>
  <div style="width: 300px">
    ...
    <Form :model="data" :label-width="60" :rules="rule" ref="form">
      ...
      <FormItem>
          <Button type="primary" @click="submit" :loading="loading.update">提交</Button>
...
export default {
  ...
  methods: {
    getInfo () {
      this.$store.dispatch('admin/show', this.$route.params.id)
        .then(res => {
    ...
    submit () {
      this.$store.dispatch('admin/update', this.data)
        .then(res => {
          this.closeWin()
